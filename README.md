...
- [ ] **TC-009**: Проверка отображения валют после нажатия кнопки Поменять местами значения
 ...
 ## 📋 Чек-лист API проверок (ветка api, проверка статус-кодов и title в ответе)
 
- [ ] **TC-101**: Открыть страницу "Все финансы" (https://yandex.ru/finance)
- [ ] **TC-102**: Открыть страницу "Кредиты" (https://yandex.ru/finance/credit)
- [ ] **TC-103**: Открыть страницу "ОСАГО" (https://yandex.ru/finance/osago/calculator)
- [ ] **TC-104**: Открыть страницу "Ипотека" (https://yandex.ru/finance/mortgage)
- [ ] **TC-105**: Открыть страницу "Финансовый словарь", буква "Н" (https://yandex.ru/finance/dictionary/n)
